...
// import { createCoutSpring, deleteCoutSpring, getAllCoutFirstSpring, getAllCoutLastSpring, getAllCoutSpring } from './spring'
...
//     const a = await getTicket(id)
//     let lasts
//     if (mode == 1) {
//         lasts = (await getAllCoutLastSpring(id)).data
//     } else if (mode == 2) {
//         lasts = (await getAllCoutFirstSpring(id)).data
//     } else if (mode == 3 || mode == 4) {
//         lasts = (await getAllCoutSpring(id)).data.filter(a => a.motif == "cout")
//     }
...
//     if (lasts[0]) {
//         f = lasts[0].groupe
//         for (const i of lasts) {
//             let calcul = 0
//             //moyenne
//             if (mode == 3) {
//                 calcul = (moyenne(lasts,formData.pourc)* formData.pourc / 100)/a.data.items.length
//             } 
//             //somme
//             else if (mode == 4) {
//                 calcul = (somme(lasts,formData.pourc)* formData.pourc / 100)/a.data.items.length
//             } else {
//                 calcul = (i.coutSuper) * formData.pourc / 100
//             }
//             createCoutSpring({
//                 idTicket: formData.idTicket,
//                 groupe: (f),
...
//     }
//     for (const e of a.data.items) {
//         await createCoutSpring({ idTicket: formData.idTicket, groupe: (f + 1), coutSuper: formData.coutSuper / a.data.items.length, itemType: e.itemtype, motif: "cout" })
//     }
// }
